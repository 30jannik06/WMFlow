    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: "180px", fontWeight: 900, lineHeight: 0.85, color: "#f4ede0", letterSpacing: "-0.04em" }}>
            wm
          </div>
          <div style={{ fontSize: "180px", fontWeight: 900, lineHeight: 0.85, color: "#d4ff3d", letterSpacing: "-0.04em", fontStyle: "italic" }}>
            flow
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ color: "rgba(244,237,224,0.4)", fontSize: "18px", letterSpacing: "0.1em" }}>
            48 Teams · 104 Matches · 3 Nations
          </div>
